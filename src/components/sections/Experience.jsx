              ...
              return (
                ...
                >
                  ...
                  <motion.div
                    ...
                    className="w-full md:w-[45%] glass-panel p-6 sm:p-8 rounded-3xl border border-white/10 hover:border-cyan-400/50 hover:shadow-glow-blue transition-all group"
                  >
                    <div className="flex items-center justify-between mb-4">
                      <span className="px-3.5 py-1 rounded-full text-xs font-mono font-bold text-cyan-300 glass-panel border border-cyan-400/40">
                        {item.period}
                      </span>
